 ...
 */
class SkinnableTextView : AppCompatButton, SkinView {
    private var attrsBean: AttrsBean = AttrsBean()

    private var shouldSkin: Boolean = false;
    ...
    constructor(context: Context, attributeSet: AttributeSet?, defStyleAttr: Int) : super(
        ...
        attrsBean.saveResourceId(R.string.custom_typeface)
...
//        int customTypeFace = attrsBean.getViewResource(R.string.custom_typeface);
...
//        int customTypeFace = attrsBean.getViewResource(R.string.custom_typeface);
        if (SkinManager.instance.isDefaultSkin()) {
            ...
            setTypeface(SkinManager.instance.getTypeface(R.string.custom_typeface))
        }
//        }
    }
}
